...
// color set 2
#define DO_TITLE_BOX                DO_RGB(52, 152, 219)
#define DO_NORMAL_BOX               DO_RGB(236, 240 , 241)
#define DO_BUTTON_BOX               DO_RGB(44, 62, 80)
#define DO_DESTRUCTIVE_BOX          DO_RGB(231, 76, 60)
...
#define DO_TEXT_FONT        [UIFont fontWithName:@"Avenir-Medium" size:24]
#define DO_BOLD_FONT        [UIFont fontWithName:@"Avenir-Heavy" size:24]

#define DO_LABEL_INSET      UIEdgeInsetsMake(10, 10, 10, 10)
#define DO_TITLE_INSET      UIEdgeInsetsMake(5, 10, 5, 10)
#define DO_VIEW_WIDTH       480//280

#define DO_YES_TAG          300//100
#define DO_NO_TAG           400//200
...
// Wothout any button, but need call hideAlertMethod
- (void)doAlert:(NSString *)strTitle
           body:(NSString *)strBody
           done:(DoAlertViewHandler)done;
